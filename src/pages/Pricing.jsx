...
const PLANS = [
  {
    ...
    price: 0,
    period: null,
    desc: 'Topluluğa katıl, temel servis taleplerini gör',
    icon: null,
    accent: 'border-zinc-700',
    btnClass: 'btn-secondary',
    features: [
      { text: 'Profil oluştur', ok: true },
      { text: 'Servis talep listesini gör (isim, sorun, ilçe)', ok: true },
      { text: 'İlgileniyorum butonu (bildirim gönder)', ok: true },
      { text: 'Maksimum 3 fotoğraf', ok: true },
      { text: 'Talep iletişim bilgileri (3 ücretsiz hak)', ok: true },
      { text: 'Mesajlaşma & teklif gönderme', ok: false },
      { text: 'Randevu yönetimi', ok: false },
  ...
  },
  {
    ...
    price: 299,
    period: 'ay',
    desc: 'Tüm servis taleplerine eriş, işini büyüt',
    icon: Flame,
    ...
    popular: true,
    features: [
      { text: 'Sınırsız talep iletişim bilgisi', ok: true },
      { text: 'Mesajlaşma & sınırsız teklif', ok: true },
      { text: 'Randevu yönetimi', ok: true },
      { text: 'Profil & dönüşüm istatistikleri', ok: true },
      { text: 'Sınırsız fotoğraf yükleme', ok: true },
      { text: 'Öncelikli listeleme', ok: false },
  ...
  },
  {
    ...
    price: 599,
    period: 'ay',
    desc: 'Maksimum görünürlük, tam analitik, öncelikli destek',
    icon: Zap,
    ...
    features: [
      ...
      { text: 'Arama sonuçlarında öncelikli sıralama', ok: true },
      { text: 'Verified rozet', ok: true },
      { text: 'Rakip kıyaslama & talep hunisi analizi', ok: true },
      { text: 'WhatsApp entegrasyonu', ok: true },
      { text: '3 kullanıcıya kadar ekip hesabı', ok: true },
      { text: 'Öncelikli destek', ok: true },
      { text: 'En çok aranan hizmetler raporu', ok: true },
    ],
  },
]
