  ...
  return (
    <div className="card hover:border-zinc-700 transition-all overflow-hidden p-0">
      {zoomed && (
        ...
        >
          <button className="absolute top-4 right-4 p-2 rounded-full bg-zinc-800 text-zinc-300 hover:text-white hover:bg-zinc-700 transition-colors">
            <X className="h-5 w-5" />
          </button>
          <img
...
function VehicleModal({ vehicle, onClose, onSaved }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm" onClick={onClose}>
      <div className="w-full max-w-lg bg-zinc-900 rounded-2xl border border-zinc-800 overflow-y-auto max-h-[90vh]" onClick={e => e.stopPropagation()}>
        ...
        <div className="p-5 space-y-4">
          ...
          {imagePreview ? (
            ...
            <button type="button" onClick={() => fileRef.current?.click()}
              ...
              <span className="text-sm">Araç fotoğrafı ekle</span>
            </button>
          )}
          ...
          {/* Notes */}
          <div>
            <label className="block text-xs font-medium text-zinc-400 mb-1.5">Notlar <span className="text-zinc-600 font-normal">(isteğe bağlı)</span></label>
    ...
    <div className="max-w-3xl mx-auto">
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-zinc-500 text-sm">Araçlarını kaydet ve bilgilerini takip et</p>
        </div>
      ...
      {loading ? (
        ...
        <div className="card text-center py-16">
          ...
          <p className="text-zinc-500 text-sm mb-6 max-w-xs mx-auto">
            Araçlarını ekleyerek marka, model, kilometre ve servis bilgilerini kaydet
          </p>
